    ...
    <div id="main-box">    
        ...
        <div class="contenedorColumnas">
            <div class="columna">
                ...
                <img src="{{ asset('img/login.webp') }}" alt="login" class="col-img">            
            ...
            <div class="columna">
                ...
                <img src="{{ asset('img/control-panel.png') }}" alt="login" class="col-img"> 
            ...
            <h2>Panel principal</h2>
                <img src="{{ asset('img/calendar-user.png') }}" alt="login" class="col-img" style="height:250px"> 
